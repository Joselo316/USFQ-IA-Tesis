"""
Script de entrenamiento supervisado para modelo 2: Clasificador basado en ResNet/WideResNet.
"""
...
class ResNetClassifier(nn.Module):
    ...
    def __init__(self, backbone: str = 'wide_resnet50_2', num_classes: int = 2, pretrained: bool = True):
        ...
        if backbone == 'resnet18':
            ...
            feature_dims = 1280
            # EfficientNet usa features en lugar de children
            self.encoder = model.features
            # Necesitamos agregar AdaptiveAvgPool2d
            ...
            feature_dims = 512
            # VGG16 tiene una estructura diferente
            self.encoder = model.features
            self.encoder = nn.Sequential(
                self.encoder,
                nn.AdaptiveAvgPool2d(1)
            ...
            feature_dims = 1024
            # DenseNet tiene estructura diferente
            self.encoder = nn.Sequential(
                model.features,
...
def main():
    parser = argparse.ArgumentParser(description='Entrenar clasificador supervisado modelo 2')
    ...
    run_name = f"modelo2_{args.backbone}_{timestamp}"
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            if not args.early_stopping or mejora >= args.min_delta:
                ...
                patience_counter = 0
                model_path = os.path.join(output_dir, f"modelo2_{args.backbone}.pt")
