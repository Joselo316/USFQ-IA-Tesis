"""
Script de entrenamiento supervisado para modelo 4: Clasificador basado en ResNet (reemplaza FastFlow).
"""
...
def main():
    parser = argparse.ArgumentParser(description='Entrenar clasificador supervisado modelo 4')
    ...
    run_name = f"modelo4_{args.backbone}_{timestamp}"
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            if not args.early_stopping or mejora >= args.min_delta:
                ...
                patience_counter = 0
                model_path = os.path.join(output_dir, f"modelo4_{args.backbone}.pt")
